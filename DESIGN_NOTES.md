...
1. *Limitation:* The data can become stale.
   *Improvement:* Add last_verified dates; verify info against the college website, or pull from 
   a live feed.

2. *Limitation:* The system is only as trustworthy as its source data. 
   *Improvement:* Put a human verification check in every resource; output "Error" instead 
   of inventing data.

3. *Limitation:* Rate limits may pause heavy use.
   *Improvement:* Future versions can queue or cache frequently asked questions.
